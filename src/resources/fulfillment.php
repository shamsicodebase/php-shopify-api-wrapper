    ...
    */
    ...
    "operations" => array(
        ...
        "getFulfillments" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{order_id}/fulfillments.json",
        ...
        "getFulfillmentCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{id}/fulfillments/count.json",
        ...
        "getFulfillment" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{order_id}/fulfillments/{id}.json",
        ...
        "completeFulfillment" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/orders/{order_id}/fulfillments/{id}/complete.json",
        ...
        "cancelFulfillment" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/orders/{order_id}/fulfillments/{id}/cancel.json",
            "summary" => "Complete a fulfillment.",
            "responseModel" => "defaultJsonResponse",
            "parameters" => array(
                "order_id" => array(
