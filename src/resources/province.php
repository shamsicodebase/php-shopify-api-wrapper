...
return array(
    ...
    */
    ...
    "operations" => array(
        ...
        "getProvinces" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2019-10/countries/{country_id}/provinces.json",
        ...
        "getProvinceCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2019-10/countries/{country_id}/provinces/count.json",
        ...
        "getProvince" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2019-10/countries/{country_id}/provinces/{id}.json",
            "summary" => "Get a count of all provinces.",
            "responseModel" => "defaultJsonResponse",
            "parameters" => array(
                "id" => array(
