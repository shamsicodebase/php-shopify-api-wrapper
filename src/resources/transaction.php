    ...
    */
    ...
    "operations" => array(
        ...
        "getTransactions" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{order_id}/transactions.json",
        ...
        "getTransactionCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{order_id}/transactions/count.json",
        ...
        "getTransaction" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/orders/{order_id}/transactions/{id}.json",
