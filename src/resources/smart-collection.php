    ...
    */
    ...
    "operations" => array(
        ...
        "getSmartCollections" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/smart_collections.json",
        ...
        "getSmartCollectionsCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/smart_collections/count.json",
        ...
        "getSmartCollection" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/smart_collections/{id}.json",
        ...
        "updateSmartCollectionOrder" => array(
            "httpMethod" => "PUT",
            "uri" => "/admin/api/2020-04/smart_collections/{id}/order.json",
