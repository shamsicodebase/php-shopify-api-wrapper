    ...
    */
    ...
    "operations" => array(
        ...
        "getCustomerAddresses" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/customers/{id}/addresses.json",
        ...
        "getCustomerAddress" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/customers/{id}/addresses/{addressId}.json",
        ...
        "createCustomerAddress" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/customers/{customer_id}/addresses.json",
        ...
        "updateCustomerAddress" => array(
            "httpMethod" => "PUT",
            "uri" => "/admin/api/2020-04/customers/{customer_id}/addresses/{id}.json",
        ...
        "deleteCustomerAddress" => array(
            "httpMethod" => "DELETE",
            "uri" => "/admin/api/2020-04/countries/{customer_id}/addresses/{id}.json",
        ...
        "deleteCustomerAddresses" => array(
            "httpMethod" => "PUT",
            "uri" => "/admin/api/2020-04/countries/{id}/addresses/set.json?operation=destroy",
        ...
        "setCustomersDefaultAddress" => array(
            "httpMethod" => "DELETE",
            "uri" => "/admin/api/2020-04/customers/{customer_id}/addresses/{id}/default.json",
