...
return array(
    ...
    */
    ...
    "operations" => array(
        ...
        "getMetafields" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/metafields.json",
        ...
        "getProductMetafields" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/products/{id}/metafields.json",
        ...
        "getProductVariantMetafields" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/variants/{id}/metafields.json",
        ...
        "getMetafieldsCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/metafields/count.json",
        ...
        "getProductMetafieldsCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/products/{id}/metafields/count.json",
        ...
        "getProductVariantMetafieldsCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/variants/{id}/metafields/count.json",
        ...
        "getMetafield" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/metafields/{id}.json",
        ...
        "getProductMetafield" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/products/{id}/metafields/{metafield_id}.json",
        ...
        "getProductVariantMetafield" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/variants/{id}/metafields/{metafield_id}.json",
        ...
        "deleteProductMetafield" => array(
            "httpMethod" => "DELETE",
            "uri" => "/admin/api/2020-04/products/{id}/metafields/{id}.json",
        ...
        "deleteProductVariantMetafield" => array(
            "httpMethod" => "DELETE",
            "uri" => "/admin/api/2020-04/variants/{id}/metafields/{id}.json",
            "summary" => "Delete a Product Metafield",
            "responseModel" => "defaultJsonResponse",
            "parameters" => array(
                "id" => array(
