...
return array(
    ...
    */
    ...
    "operations" => array(
        ...
        "getComments" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/comments.json",
        ...
        "getCommentCount" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/comments/count.json",
        ...
        "getComment" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2020-04/comments/{id}.json",
        ...
        "markCommentAsSpam" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/comments/{id}/spam.json",
        ...
        "markCommentAsNotSpam" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/comments/{id}/not_spam.json",
        ...
        "markCommentAsApproved" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/comments/{id}/approve.json",
        ...
        "removeComment" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/comments/{id}/remove.json",
        ...
        "restoreComment" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2020-04/comments/{id}/restore.json",
